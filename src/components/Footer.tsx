      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 md:gap-8">
        ...
        <div>
          ...
          <div className="flex gap-4">
            {[Instagram, Facebook, Twitter].map((Icon, i) => (
              <a key={i} href="#" className="w-9 h-9 border border-border flex items-center justify-center text-muted-foreground hover:text-primary hover:border-primary transition-colors">
                <Icon size={16} />
              </a>
            ))}
          </div>
        ...
        <div>
          ...
          <div className="space-y-3 text-sm font-body text-muted-foreground">
            <p className="flex items-start gap-2"><MapPin size={16} className="text-primary shrink-0 mt-0.5" /> 42, Jewellers Street, Zaveri Bazaar, Mumbai 400002</p>
            <p className="flex items-center gap-2"><Phone size={16} className="text-primary shrink-0" /> +91 98765 43210</p>
